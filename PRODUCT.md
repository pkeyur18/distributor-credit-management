...
- Recursive, chain-upward calculation: a member's Total Business Volume = own Business Volume + Total Business Volume of each direct child; band is set by the team figure, not the personal figure; differential and royalty derive from band gaps against direct children only. A member's own Business Volume also earns a reward at their own band (added 8 Aug 2026, CR-4) — a third, additive term alongside differential and royalty, not a change to either. Royalty is paid by monthly membership level (Gold, Platinum, Diamond, Ace — added 24 Sep 2026, CR-7): each level needs a configured number of direct legs at the level before it, and pays its own configured rate.
